...
YAO.singleTab = function(oConfigs){
	...
	this.autoSpeed = oConfigs.autoSpeed || 4000;
...
YAO.singleTab.prototype.setCurrent = function(curCnt, index){
	...
	//weina
	if(index == 0){
		$("#topImg").css("background","url(images/sinoiovbj.jpg) repeat-x");
	}
	else if(index == 1){
		$("#topImg").css("background","url(images/bj02.png) repeat-x");
	}
	else if(index == 2){
		$("#topImg").css("background","url(images/bj03.png) repeat-x");

	}else if(index == 3){
		$("#topImg").css("background","url(images/bj04.png) repeat-x");
	}
		else if(index == 4){
		$("#topImg").css("background","url(images/bj06.png) repeat-x");
	}
};
